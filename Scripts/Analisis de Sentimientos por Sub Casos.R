...
# Lista de dataframes
df_list <- list(SubCaso_NS, SubCaso_CC, SubCaso_H, SubCaso_M, SubCaso_A)
names(df_list) <- c('SubCaso_NS', 'SubCaso_CC', 'SubCaso_H', 'SubCaso_M', 'SubCaso_A')
...
annotated_names <- c("SubCaso_NS_annot", "SubCaso_CC_annot", "SubCaso_H_annot",
                     "SubCaso_M_annot", "SubCaso_A_annot")
...
TS_SubCaso_NS %>% 
  ...
  ggtitle(label = "Clasificacion y frecuencia de la prabras\nSubCaso Norte de Santander",
...
TS_SubCaso_NS %>% 
  ...
  scale_x_reordered() +
  ggtitle(label = "Top 5 lemas por categoría gramatical\nSubCaso Norte de Santander",
          subtitle = "JEP: Caso 03 - Analisis de discrusos") +
