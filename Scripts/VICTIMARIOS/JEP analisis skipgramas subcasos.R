...
# Establecer las condiciones para asignar el valor de n



setwd(paste0("C:/Users/Pc/Desktop/-Proyecto-JEP-/Outputs/Skipgramas - Victimarios/",Palabra))
...
# Código que ejecuta una acción dependiendo de la condición
if (Palabra == 'Norte de santander') {
