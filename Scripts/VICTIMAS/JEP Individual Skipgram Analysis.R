...
Todos_Titles<-Todos_Titles%>%filter(PRESUNTO==0)%>%filter(!is.na(NOMBRE))
...
for (i in 1:length(Grupos)) {
  ...
  ruta <- paste0("C:/Users/Pc/Desktop/-Proyecto-JEP-/Data/Skipgrams victims/grafo_",  str_replace_all(str_to_lower(nombre_llave), "[^a-záéíóúüñ ]", ""), ".RData")
